...
def load_data(root_path):
    with File(root_path + 'Data/H5/mRNA_kmer_k=12345678.h5','r') as f:
    ...
    with File(root_path + 'Data/H5/mRNA_CGRS_cut.h5','r') as f:
    ...
    f = open(root_path + '/checkpoints/scalar.pkl','wb')
